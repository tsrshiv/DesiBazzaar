          ...
          <div className="flex flex-wrap md:text-left text-center order-first">
            <div className="lg:w-1/4 md:w-1/2 w-full px-4">
              ...
              <nav className="list-none mb-10">
                ...
                <li>
                <Link to ={'./pages/order/Order'} className="text-gray-600 hover:text-gray-800" style={{ color: mode === 'dark' ? 'white' : '' }}>  
                  <a >Order</a>
                  </Link>
                </li>
                ...
                <li>
                <Link to ={'./pages/cart/Cart'} className="text-gray-600 hover:text-gray-800" style={{ color: mode === 'dark' ? 'white' : '' }}>  
                  <a >Cart</a>
                  </Link>
                </li>
...
{/* 
            ...
            <div className="lg:w-1/4 md:w-1/2 w-full px-4">
              <img src="https://www.businessleague.in/wp-content/uploads/2021/09/Google-Pay-PhonePe-Paytm.jpg" alt="" />
            </div>
          </div>
        ...
        <div className="bg-gray-200" style={{ backgroundColor: mode === 'dark' ? 'rgb(55 57 61)' : '', color: mode === 'dark' ? 'white' : '', }}>
          <div className="container px-5 py-3 mx-auto flex items-center sm:flex-row flex-col">
            <Link to={'/'} className='flex'>
              <div className="flex ">
                <h1 className=' text-2xl font-bold text-black  px-2 py-1 rounded' style={{ color: mode === 'dark' ? 'white' : '', }}>DesiBazar</h1>
              </div>
            </Link>
            <p className="text-sm text-gray-500 sm:ml-6 sm:mt-0 mt-4" style={{ color: mode === 'dark' ? 'white' : '' }}>© 2023 DesiBazar made from love
              {/* <a href="https://twitter.com/knyttneve" rel="noopener" className="text-gray-600 ml-1" target="_blank" style={{ color: mode === 'dark' ? 'white' : '' }}></a> */}
            </p>
            <span className="inline-flex sm:ml-auto sm:mt-0 mt-4 justify-center sm:justify-start">
              ...
              <a className="ml-3 text-gray-500" href="https://www.instagram.com/tsrshiv/" target='_blank' rel='noopener' style={{ color: mode === 'dark' ? 'white' : '' }}>
                <svg fill="none" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} className="w-5 h-5" viewBox="0 0 24 24">
                  <rect width={20} height={20} x={2} y={2} rx={5} ry={5} />
                  <path d="M16 11.37A4 4 0 1112.63 8 4 4 0 0116 11.37zm1.5-4.87h.01" />
                </svg>
              </a>
              <a className="ml-3 text-gray-500" href="https://www.linkedin.com/in/tsrshiv/" target='_blank' rel='noopener' style={{ color: mode === 'dark' ? 'white' : '' }}>
